...
uint256 hashGenesisBlock("0x0000000006bd96da78ce8ca7d5a4ffb23dcc604c374f3451deab8b15557db021");
...
const string strMessageMagic = "CryptoLOOT Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 20000 blocks, which will occur approximately every 4 years
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0000000006bd96da78ce8ca7d5a4ffb23dcc604c374f3451deab8b15557db021");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis block
        const char* pszTimestamp = "Mtgox BTCUSD 2014-02-09T13:49:08; last:678.81 buy:678.81 sell:690.49";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1391953770;
        block.nBits    = 486604799;
        block.nNonce   = 1049716082;
        ...
        assert(block.hashMerkleRoot == uint256("0x02209875a93778a7cec060e6c94600d09e00fcfed7f12c4a98e779e9b4aab7dd"));
        block.print();
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CryptoLOOTMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CryptoLOOTMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("CryptoLOOTMiner started\n");
    ...
    try { loop {
        ...
        printf("Running CryptoLOOTMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("CryptoLOOTMiner terminated\n");
        throw;
    }
}
